...
<section class="bg-gray pt-4 pb-5">
    <div class="container">
        <div class="mb-4">
            ...
            <a href="{{ route('auth.login.show') }}" class="btn btn-primary">Login to Create Discussion</a>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 col-lg-4">
                                    <div class="avatar-sm-wrapper d-inline-block">
                                        <a href="#" class="me-1">
                                            <img src="{{ url('assets/images/avatar-sm.png') }}" alt="WijayaK" class="avatar rounded-circle">
                                        </a>
                                    </div>
