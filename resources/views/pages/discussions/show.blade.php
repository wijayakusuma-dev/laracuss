                                    ...
                                    <div class="col-5 col-lg-3 d-flex">
                                        ...
                                        <div class="fs-12px lh-1">
                                            <span class="text-primary">
                                                <a href="{{ route('users.show', $discussion->user->username) }}" class="fw-bold d-flex align-items-start text-break mb-1">
                                        ...
                                        <div class="col-5 col-lg-3 d-flex">
                                            ...
                                            <div class="fs-12px lh-1">
                                                <span class="{{ $answer->user->username === $discussion->user->username
                                                    ? 'text-primary' : '' }}">
                                                    <a href="{{ route('users.show', $answer->user->username) }}" class="fw-bold d-flex align-items-start text-break mb-1">
