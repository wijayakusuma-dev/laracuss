                ...
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                    <div class="card card-discussions mb-5">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <p>
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Culpa consequatur necessitatibus voluptate similique tempora voluptates molestias sequi voluptas, optio enim facere minus pariatur? Obcaecati impedit similique qui quaerat! Ex, assumenda?
                                </p>
                                <div class="mb-3">
                    ...
                    <div class="mb-5">
                        <div class="card card-discussions">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus ab esse at error deleniti obcaecati, explicabo reprehenderit laudantium eos, sequi molestias impedit. Ea cumque qui rerum saepe ipsam eum numquam.</p>
                    ...
                    <div class="fw-bold text-center">
                        Please <a href="{{ route('auth.login.show') }}" class="text-primary">sign in</a> or
                        <a href="{{ route('auth.sign-up.show') }}" class="text-primary">
